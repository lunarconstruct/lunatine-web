...
function create_then_block(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*elementSize, onFileClicked, items, onFileDoubleClicked, reloadMasonry*/
      1896349696) {
        each_value = ensure_array_like(
          /*items*/
          ctx2[24]
...
function instance8($$self, $$props, $$invalidate) {
  ...
  function onFileDoubleClicked(file2) {
    if (file2) {
      const pt = file2.file.path;
      app2.openWithDefaultApp(pt);
    }
  }
  ...
  const contextmenu_handler = (item) => onFileDoubleClicked(item.file);
